...
class MochaAdapter {
    ...
    async run() {
        ...
        await utils_1.executeHooksWithArgs(this._config.after, [runtimeError || result, this._capabilities, this._specs]);
    ...
    wrapHook(hookName) {
        return () => utils_1.executeHooksWithArgs(this._config[hookName], this.prepareMessage(hookName)).catch((e) => {
